...
local function errorhandler(err)
	if DEFAULT_CHAT_FRAME then
		DEFAULT_CHAT_FRAME:AddMessage("|cffff5555VoiceOver: "..tostring(err).."|r")
		if debugstack then
			DEFAULT_CHAT_FRAME:AddMessage("|cffffaaaa"..debugstack(3, 12, 2).."|r")
		end
	end
